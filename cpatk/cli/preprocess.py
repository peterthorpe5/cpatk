...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--trim_objects", action="store_true", help="When --input_dir is used, optionally trim extreme object rows before object-table aggregation. Disabled by default.")
