...
# malaria and/or mitotox v0.2.18/v0.2.23 stress-test runs into a small review folder,
...
PATHS
  ...
  copy_if_present "${result_dir}/02_profile_build/object_aggregation_report.tsv" "${dest_root}/02_profile_build/object_aggregation_report.tsv"
  copy_if_present "${result_dir}/02_profile_build/object_key_propagation_report.tsv" "${dest_root}/02_profile_build/object_key_propagation_report.tsv"
  ...
  for strategy_dir in "${result_dir}"/03_preprocess_strategy_comparison/*; do
    ...
    copy_if_present "${strategy_dir}/feature_qc.tsv" "${dest_root}/03_preprocess_strategy_comparison/${strategy_name}/feature_qc.tsv"
    copy_if_present "${strategy_dir}/sample_qc.tsv" "${dest_root}/03_preprocess_strategy_comparison/${strategy_name}/sample_qc.tsv"
    copy_if_present "${strategy_dir}/sample_qc_before_feature_qc.tsv" "${dest_root}/03_preprocess_strategy_comparison/${strategy_name}/sample_qc_before_feature_qc.tsv"
    copy_if_present "${strategy_dir}/sample_qc_after_feature_qc.tsv" "${dest_root}/03_preprocess_strategy_comparison/${strategy_name}/sample_qc_after_feature_qc.tsv"
    copy_if_present "${strategy_dir}/feature_selection_summary.tsv" "${dest_root}/03_preprocess_strategy_comparison/${strategy_name}/feature_selection_summary.tsv"
    copy_if_present "${strategy_dir}/feature_selection_report.tsv" "${dest_root}/03_preprocess_strategy_comparison/${strategy_name}/feature_selection_report.tsv"
    copy_if_present "${strategy_dir}/protected_feature_audit.tsv" "${dest_root}/03_preprocess_strategy_comparison/${strategy_name}/protected_feature_audit.tsv"
    copy_if_present "${strategy_dir}/correlation_filter_report.tsv" "${dest_root}/03_preprocess_strategy_comparison/${strategy_name}/correlation_filter_report.tsv"
    copy_if_present "${strategy_dir}/retained_features.tsv" "${dest_root}/03_preprocess_strategy_comparison/${strategy_name}/retained_features.tsv"
  done
  ...
  copy_if_present "${result_dir}/12_clipn/clipn_training_summary.tsv" "${dest_root}/12_clipn/clipn_training_summary.tsv"
  copy_if_present "${result_dir}/12_clipn/clipn_training_loss.tsv" "${dest_root}/12_clipn/clipn_training_loss.tsv"
