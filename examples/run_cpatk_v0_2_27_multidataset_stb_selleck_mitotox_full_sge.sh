...
# CPATK v0.2.27 large multi-dataset Cell Painting stress test.
#
...
PROJECT_OUT_DIR="${PROJECT_OUT_DIR:-${OUT_DIR:-/home/pthorpe001/data/2025_jason_cell_painting/data/cpatk_v0_2_27_multidataset_${RUN_TAG}}}"
...
if [[ "${RUN_FINAL_REPORT}" == "1" ]]; then
  ...
  REPORT_ARGS=(
    --output_html "${WORK_OUT_DIR}/CPATK_multidataset_v0_2_27_full_report.html"
    --title "CPATK v0.2.27 multi-dataset Cell Painting stress test"
